...
// source: util/hlc/hlcpb/legacy_timestamp.proto
...
namespace protobuf_util_2fhlc_2fhlcpb_2flegacy_5ftimestamp_2eproto {
static void InitDefaultsLegacyTimestamp() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::cockroach::util::hlc::hlcpb::_LegacyTimestamp_default_instance_;
    new (ptr) ::cockroach::util::hlc::hlcpb::LegacyTimestamp();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::cockroach::util::hlc::hlcpb::LegacyTimestamp::InitAsDefaultInstance();
}
...
LegacyTimestamp::LegacyTimestamp()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_util_2fhlc_2fhlcpb_2flegacy_5ftimestamp_2eproto::scc_info_LegacyTimestamp.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:cockroach.util.hlc.hlcpb.LegacyTimestamp)
}
LegacyTimestamp::LegacyTimestamp(const LegacyTimestamp& from)
  ...
  // @@protoc_insertion_point(copy_constructor:cockroach.util.hlc.hlcpb.LegacyTimestamp)
}
...
LegacyTimestamp::~LegacyTimestamp() {
  // @@protoc_insertion_point(destructor:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  SharedDtor();
}
...
const LegacyTimestamp& LegacyTimestamp::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_util_2fhlc_2fhlcpb_2flegacy_5ftimestamp_2eproto::scc_info_LegacyTimestamp.base);
  return *internal_default_instance();
}


void LegacyTimestamp::Clear() {
// @@protoc_insertion_point(message_clear_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  return false;
#undef DO_
}
...
void LegacyTimestamp::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:cockroach.util.hlc.hlcpb.LegacyTimestamp)
}

size_t LegacyTimestamp::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
...
// @@protoc_insertion_point(class_specific_copy_from_start:cockroach.util.hlc.hlcpb.LegacyTimestamp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string LegacyTimestamp::GetTypeName() const {
  return "cockroach.util.hlc.hlcpb.LegacyTimestamp";
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cockroach::util::hlc::hlcpb::LegacyTimestamp* Arena::CreateMaybeMessage< ::cockroach::util::hlc::hlcpb::LegacyTimestamp >(Arena* arena) {
  return Arena::CreateInternal< ::cockroach::util::hlc::hlcpb::LegacyTimestamp >(arena);
}
}  // namespace protobuf
}  // namespace google
