...
type ReplicatedEvalResult struct {
	...
	// threshold).
	Timestamp            cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,8,opt,name=timestamp" json:"timestamp"`
	...
	PrevLeaseProposal *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,20,opt,name=prev_lease_proposal,json=prevLeaseProposal" json:"prev_lease_proposal,omitempty"`
}
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			if m.PrevLeaseProposal == nil {
				m.PrevLeaseProposal = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
