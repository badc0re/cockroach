...
type ReplicaState struct {
	...
	// not be served.
	GCThreshold *cockroach_util_hlc_hlcpb.Timestamp           `protobuf:"bytes,6,opt,name=gc_threshold,json=gcThreshold" json:"gc_threshold,omitempty" cockroachdb:"randnullable"`
	...
	// transaction entry.
	TxnSpanGCThreshold *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,9,opt,name=txn_span_gc_threshold,json=txnSpanGcThreshold" json:"txn_span_gc_threshold,omitempty" cockroachdb:"randnullable"`
...
func (m *ReplicaState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.GCThreshold == nil {
				m.GCThreshold = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
		...
		case 9:
			...
			if m.TxnSpanGCThreshold == nil {
				m.TxnSpanGCThreshold = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
var fileDescriptorState = []byte{
	...
	,
}
