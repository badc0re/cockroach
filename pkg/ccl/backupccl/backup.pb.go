...
type BackupDescriptor struct {
	...
	RevisionStartTime cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,17,opt,name=revision_start_time,json=revisionStartTime" json:"revision_start_time"`
...
type BackupDescriptor_File struct {
	...
	StartTime cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,7,opt,name=start_time,json=startTime" json:"start_time"`
	EndTime   cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,8,opt,name=end_time,json=endTime" json:"end_time"`
}
...
type BackupDescriptor_DescriptorRevision struct {
	Time cockroach_util_hlc_hlcpb.Timestamp                  `protobuf:"bytes,1,opt,name=time" json:"time"`
...
var fileDescriptorBackup = []byte{
	...
	,
}
