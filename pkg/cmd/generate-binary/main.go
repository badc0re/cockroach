...
var inputs = map[string][]string{
	...
	"SELECT '%s'::time": []string{
		"00:00:00",
		"12:00:00.000001",
		"23:59:59.999999",
	},

	"SELECT '%s'::interval": []string{
		"10y10mon",
		"10mon10d",
		"1y1mon",
		"1y1m",
