...
type ReadWithinUncertaintyIntervalError struct {
	...
	// error message.
	ReadTimestamp     cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,1,opt,name=read_timestamp,json=readTimestamp" json:"read_timestamp"`
	ExistingTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=existing_timestamp,json=existingTimestamp" json:"existing_timestamp"`
	// The remaining fields may be missing when running in clusters that have
	// members at below CockroachDB v2.0.
	MaxTimestamp       *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,3,opt,name=max_timestamp,json=maxTimestamp" json:"max_timestamp,omitempty"`
...
type WriteTooOldError struct {
	...
	ActualTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=actual_timestamp,json=actualTimestamp" json:"actual_timestamp"`
}
...
type BatchTimestampBeforeGCError struct {
	Timestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,1,opt,name=Timestamp" json:"Timestamp"`
	Threshold cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=Threshold" json:"Threshold"`
}
...
type Error struct {
	...
	Now cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,8,opt,name=now" json:"now"`
}
...
func (m *ReadWithinUncertaintyIntervalError) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.MaxTimestamp == nil {
				m.MaxTimestamp = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
var fileDescriptorErrors = []byte{
	...
	,
}
