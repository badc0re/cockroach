...
type Transaction struct {
	...
	LastHeartbeat cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=last_heartbeat,json=lastHeartbeat" json:"last_heartbeat"`
	...
	// achieve anything).
	OrigTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,6,opt,name=orig_timestamp,json=origTimestamp" json:"orig_timestamp"`
	...
	MaxTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,7,opt,name=max_timestamp,json=maxTimestamp" json:"max_timestamp"`
	...
	RefreshedTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,15,opt,name=refreshed_timestamp,json=refreshedTimestamp" json:"refreshed_timestamp"`
	...
	EpochZeroTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,14,opt,name=epoch_zero_timestamp,json=epochZeroTimestamp" json:"epoch_zero_timestamp"`
...
type Lease struct {
	...
	Start cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,1,opt,name=start" json:"start"`
	// The expiration is a timestamp at which the lease expires. This means that
	// a new lease can be granted for a later timestamp.
	Expiration *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=expiration" json:"expiration,omitempty" cockroachdb:"randnullable"`
	...
	DeprecatedStartStasis *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,4,opt,name=deprecated_start_stasis,json=deprecatedStartStasis" json:"deprecated_start_stasis,omitempty" cockroachdb:"randnullable"`
	...
	ProposedTS *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=proposed_ts,json=proposedTs" json:"proposed_ts,omitempty"`
...
func NewPopulatedObservedTimestamp(r randyData, easy bool) *ObservedTimestamp {
	...
	v3 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.Timestamp = *v3
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	v5 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.LastHeartbeat = *v5
	v6 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.OrigTimestamp = *v6
	v7 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	...
	v12 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.EpochZeroTimestamp = *v12
	v13 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
...
func NewPopulatedLease(r randyData, easy bool) *Lease {
	this := &Lease{}
	v14 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.Start = *v14
	if r.Intn(10) != 0 {
		this.Expiration = cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	}
	v15 := NewPopulatedReplicaDescriptor(r, easy)
	this.Replica = *v15
	if r.Intn(10) != 0 {
		this.DeprecatedStartStasis = cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	}
	if r.Intn(10) != 0 {
		this.ProposedTS = cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	}
...
func NewPopulatedAbortSpanEntry(r randyData, easy bool) *AbortSpanEntry {
	...
	v17 := cockroach_util_hlc_hlcpb.NewPopulatedTimestamp(r, easy)
	this.Timestamp = *v17
...
func (m *Lease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Expiration == nil {
				m.Expiration = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
		...
		case 4:
			...
			if m.DeprecatedStartStasis == nil {
				m.DeprecatedStartStasis = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
		...
		case 5:
			...
			if m.ProposedTS == nil {
				m.ProposedTS = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
var fileDescriptorData = []byte{
	...
	,
}
