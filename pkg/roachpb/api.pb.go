...
type EndTransactionRequest struct {
	...
	// forced to restart.
	Deadline *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,3,opt,name=deadline" json:"deadline,omitempty"`
...
type HeartbeatTxnRequest struct {
	RequestHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Now           cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=now" json:"now"`
}
...
type GCRequest struct {
	...
	Threshold cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,4,opt,name=threshold" json:"threshold"`
	...
	TxnSpanGCThreshold cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=txn_span_gc_threshold,json=txnSpanGcThreshold" json:"txn_span_gc_threshold"`
}
...
type PushTxnRequest struct {
	...
	PushTo cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,4,opt,name=push_to,json=pushTo" json:"push_to"`
	...
	Now cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=now" json:"now"`
...
type ResolveIntentRangeRequest struct {
	...
	MinTimestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=min_timestamp,json=minTimestamp" json:"min_timestamp"`
}
...
type RequestLeaseRequest struct {
	...
	MinProposedTS *cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,4,opt,name=min_proposed_ts,json=minProposedTs" json:"min_proposed_ts,omitempty"`
}
...
type ExportRequest struct {
	...
	StartTime     cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,3,opt,name=start_time,json=startTime" json:"start_time"`
...
type ImportRequest struct {
	...
	// imported.
	EndTime cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,6,opt,name=end_time,json=endTime" json:"end_time"`
...
type SubsumeResponse struct {
	...
	FreezeStart cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,5,opt,name=freeze_start,json=freezeStart" json:"freeze_start"`
}
...
type Header struct {
	...
	Timestamp cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,1,opt,name=timestamp" json:"timestamp"`
...
type RangeFeedCheckpoint struct {
	Span       Span                               `protobuf:"bytes,1,opt,name=span" json:"span"`
	ResolvedTS cockroach_util_hlc_hlcpb.Timestamp `protobuf:"bytes,2,opt,name=resolved_ts,json=resolvedTs" json:"resolved_ts"`
}
...
func (m *EndTransactionRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Deadline == nil {
				m.Deadline = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
func (m *RequestLeaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.MinProposedTS == nil {
				m.MinProposedTS = &cockroach_util_hlc_hlcpb.Timestamp{}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
