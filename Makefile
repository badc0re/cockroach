...
CPP_PROTOS := $(filter %/roachpb/metadata.proto %/roachpb/data.proto %/roachpb/internal.proto %/engine/enginepb/mvcc.proto %/engine/isolation/isolation.proto %/engine/enginepb/mvcc3.proto %/engine/enginepb/file_registry.proto %/engine/enginepb/rocksdb.proto %/hlc/hlcpb/legacy_timestamp.proto %/hlc/hlcpb/timestamp.proto %/unresolved_addr.proto,$(GO_PROTOS))
